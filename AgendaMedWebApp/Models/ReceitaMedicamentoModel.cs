...
namespace AgendaMedWebApp.Models
{
    public class ReceitaMedicamentoModel
    {
        ...
        public ReceitaMedicamentoModel (ReceitaMedicamentos medicamento)
        {
            ...
            Dosage = medicamento.Dosage;
            Prescription = medicamento.Prescription;
        }

        public ReceitaMedicamentos GetReceitaMedicamento()
        {
            return new ReceitaMedicamentos() { Id = Id, Medication_Id = AgendaMed.Business.Genericos.Medicamento.ReadOne(Medication_Id.Id), Prescription_Id = Prescription_Id, Dosage = Dosage, Prescription = Prescription };
        }
    }
}
}
